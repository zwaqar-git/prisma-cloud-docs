...
+
In this example, you see the scan result of a Checkov CLI run for an SCA scan with information on licensing violations.ß
+
...
+
In this example, you see the scan result of a license violation with contextualized information of the violation in *Resource Explorer > Errors*.
+
...
. Access a specific license violation to suppress.
+
...
.. Add a justification as a definitive explanation for suppressing the specific violation.
+
...
+
* Suppress by license types: This option suppresses all findings for that license type across your repositories.
* Suppression by package: This option suppresses any license violation for that package.
+
